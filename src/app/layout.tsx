...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className={`font-sfmono bg-slate-200 dark:bg-slate-900 text-sm text-slate-800 dark:text-slate-400 ${calibre.variable} ${sfmono.variable}`}>
        <main className="max-w-2xl px-4 mb-8 mx-auto">

          <nav className="flex justify-between w-full mb-8 py-8">
            <Link href={'/'} className="link">
              <div>
                <span className="text-sky-700 dark:text-sky-300">obay</span>.<span className="text-sky-700 dark:text-sky-300">dev</span>();
              </div>
            </Link>
            <div className="flex">
              ...
              <Link className="flex link text-black dark:text-slate-400" href="https://github.com/obiefy">
          ...
          <div className="mt-12 text-center">
            Built with <Link className="link text-sky-700 dark:text-sky-300" href={'https://nextjs.org/'}>Next.js</Link>,{' '}
            <Link className="link text-sky-700 dark:text-sky-300" href={'https://tailwindcss.com/'}>TailwindCSS</Link>, and
            <Link className="link text-sky-700 dark:text-sky-300" href={'https://vercel.com/'}> Vercel</Link>. 
          </div>
